      ...
      if (response.ok) {
        ...
        if (result.results && result.results.length > 0) {
          ...
          if (screenshotResult) {
            ...
            console.log('📸 Browser initialized, viewport should show');
          }
        }
      }
    } catch (error) {
    ...
    messages = [
      {
        id: generateUniqueId(),
        role: 'assistant',
        content: "Hi there! I'm your friendly chat assistant with browser capabilities. How can I help you today?"
      }
    ];
    isStartState = true;
    omnibarPrompt = '';
      ...
      messages = [
        {
          id: generateUniqueId(),
          role: 'assistant',
          content: "Hi there! I'm your friendly chat assistant with browser automation capabilities. Try commands like 'open linkedin' or 'go to google.com' to see the live browser in action!"
        }
      ];
      isStartState = true;
      isInitialized = true;
    ...
    <div class="browser-viewport" in:fade={{ duration: 300 }}>
      <div class="browser-header">
        ...
        <div class="browser-title">
          {browserLiveViewUrl ? 'Live Browser Session' : 'Browser Screenshot'}
        </div>
        <button
          class="browser-close"
      ...
      <div class="browser-content">
        ...
        {:else if browserLiveViewUrl}
          <!-- Live browser view using iframe -->
          <iframe
